...
<html lang="en">
  ...
  <body>
		      ...
		      <form class="form-login" action="admin.php" method="POST">
		        ...
		        <div class="login-wrap">
		            ...
		            <div class="registration">
		                ...
		                <a data-toggle="modal" href="login.html#myModal02"> Acesse aqui?</a>
		            </div>
		
		        </div>
		
		          <!-- Modal -->
		          <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModal01" class="modal fade">
		          ...
		          <!-- Modal -->
		          <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModal02" class="modal fade">
		              <div class="modal-dialog">
		                  <div class="modal-content">
		                      <div class="modal-header">
		                          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
		                          <h4 class="modal-title">Deseja criar uma conta ?</h4>
		                      </div>
		                      <div class="modal-body">
		                          <p>Digite seu email abaixo para entrar em contato com o administrador.</p>
    ...
    <script>
        $.backstretch("assets/img/login-bg-novo.jpg", {speed: 500});
    </script>
